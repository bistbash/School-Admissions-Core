...
export const PAGE_PERMISSIONS: Record<string, PagePermission> = {
  ...
  'student-exits': {
    ...
    descriptionHebrew: 'ניהול רשומות יציאת תלמידים',
    detailedExplanation: 'הרשאה זו מאפשרת ניהול רשומות יציאת תלמידים מהמערכת. עם הרשאת צפייה ניתן לראות רשימת יציאות תלמידים ופרטי יציאה ספציפית. עם הרשאת עריכה ניתן ליצור רשומות יציאה חדשות, לעדכן פרטי יציאות קיימות, ולמחוק רשומות יציאה. רק אדמינים יכולים לערוך יציאות תלמידים.',
    category: 'academic',
    categoryHebrew: 'אקדמי',
    viewAPIs: [
      ...
      { resource: 'student-exits', action: 'read', method: 'GET', path: '/api/student-exits/:id', description: 'Get student exit by ID', descriptionHebrew: 'קבלת יציאת תלמיד לפי מזהה' },
    ],
    editAPIs: [
      { resource: 'student-exits', action: 'create', method: 'POST', path: '/api/student-exits', description: 'Create student exit record', descriptionHebrew: 'יצירת רשומת יציאת תלמיד' },
      { resource: 'student-exits', action: 'update', method: 'PUT', path: '/api/student-exits/:id', description: 'Update student exit', descriptionHebrew: 'עדכון יציאת תלמיד' },
      { resource: 'student-exits', action: 'delete', method: 'DELETE', path: '/api/student-exits/:id', description: 'Delete student exit', descriptionHebrew: 'מחיקת יציאת תלמיד' },
    ],
    adminOnly: true,
  },
