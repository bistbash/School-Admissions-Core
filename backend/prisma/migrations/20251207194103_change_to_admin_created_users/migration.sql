/*
  ...
  - You are about to drop the column `registrationIp` on the `Soldier` table. All the data in the column will be lost.
...
INSERT INTO "new_Soldier" ("approvalStatus", "createdAt", "departmentId", "email", "id", "isAdmin", "isCommander", "name", "password", "personalNumber", "roleId", "type", "updatedAt") SELECT "approvalStatus", "createdAt", "departmentId", "email", "id", "isAdmin", "isCommander", "name", "password", "personalNumber", "roleId", "type", "updatedAt" FROM "Soldier";
DROP TABLE "Soldier";
